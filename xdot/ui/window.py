...
class DotWindow(Gtk.Window):
    ...
    def __init__(self, widget=None, width=512, height=512):
        ...
        actiongroup.add_actions((
            ('Open', None, 'Open', None, None, self.on_open),
            ('Reload', None, 'Reload', None, None, self.on_reload),
            ('Print', None, 'Print', None,
             "Prints the currently visible part of the graph", self.dotwidget.on_print),
            ('ZoomIn', None, 'ZoomIn', None, None, self.dotwidget.on_zoom_in),
            ('ZoomOut', None, 'ZoomOut', None, None, self.dotwidget.on_zoom_out),
            ('ZoomFit', None, 'ZoomFit', None, None, self.dotwidget.on_zoom_fit),
            ('Zoom100', None, 'Zoom100', None, None, self.dotwidget.on_zoom_100),
        ))

        actiongroup.get_action('Open').set_gicon(GdkPixbuf.Pixbuf.new_from_file(
            os.path.join(CURRENT_DIR, './icons/48x48/document-open.png')))

        actiongroup.get_action('Reload').set_gicon(GdkPixbuf.Pixbuf.new_from_file(
            os.path.join(CURRENT_DIR, './icons/48x48/view-refresh.png')))

        actiongroup.get_action('Print').set_gicon(GdkPixbuf.Pixbuf.new_from_file(
            os.path.join(CURRENT_DIR, './icons/48x48/document-print.png')))

        actiongroup.get_action('ZoomIn').set_gicon(GdkPixbuf.Pixbuf.new_from_file(
            os.path.join(CURRENT_DIR, './icons/48x48/zoom-in.png')))

        actiongroup.get_action('ZoomOut').set_gicon(GdkPixbuf.Pixbuf.new_from_file(
            os.path.join(CURRENT_DIR, './icons/48x48/zoom-out.png')))

        actiongroup.get_action('ZoomFit').set_gicon(GdkPixbuf.Pixbuf.new_from_file(
            os.path.join(CURRENT_DIR, './icons/48x48/zoom-fit-best.png')))

        actiongroup.get_action('Zoom100').set_gicon(GdkPixbuf.Pixbuf.new_from_file(
            os.path.join(CURRENT_DIR, './icons/48x48/zoom-original.png')))
        ...
        self.textentry = Gtk.Entry(max_length=50)
        self.textentry.set_placeholder_text('Search')
        self.textentry.set_icon_from_pixbuf(0, GdkPixbuf.Pixbuf.new_from_file(
            os.path.join(CURRENT_DIR, './icons/48x48/edit-find.png')))
