...
setup(
    ...
    version='1.0',
    author='Luffy Yu',
    author_email='ylch_top@sina.com',
    url='https://github.com/luffy-yu/mac-xdot.git',
    ...
    package_data={'mac-xdot': ['xdot/ui/icons/48x48']},
    entry_points=dict(gui_scripts=['mac-xdot=xdot.__main__:main']),
